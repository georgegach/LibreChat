      ...
      <div className="mt-6 w-96 overflow-hidden bg-white px-6 py-4 sm:max-w-md sm:rounded-lg">
        ...
        >
          <div className="mb-2">
            <div className="relative">
              ...
              <label
                htmlFor="name"
                className="absolute left-2.5 top-4 z-10 origin-[0] -translate-y-4 scale-75 transform text-sm text-gray-500 duration-300 peer-placeholder-shown:translate-y-0 peer-placeholder-shown:scale-100 peer-focus:-translate-y-4 peer-focus:scale-75 peer-focus:text-indigo-500"
              >
          ...
          <div className="mt-6">
            <button
              ...
              className="w-full transform rounded-sm bg-indigo-500 px-4 py-3 tracking-wide text-white transition-colors duration-200 hover:bg-indigo-600 focus:bg-indigo-600 focus:outline-none disabled:cursor-not-allowed disabled:opacity-50 disabled:hover:bg-indigo-500"
            >
        ...
        <p className="my-4 text-center text-sm font-light text-gray-700">
          ...
          <a
            href="/login"
            aria-label="Login"
            className="p-1 font-medium text-indigo-500 hover:underline"
          >
